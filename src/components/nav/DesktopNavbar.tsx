...
export default function DesktopNavbar() {
    return (
        <nav style={saira.style} className="hidden md:flex w-full fixed z-20 md:px-32 2xl:px-48 md:py-4 2xl:py-8 items-center justify-between p-4 bg-black text-white border-b-amber-600 border-b-2">
