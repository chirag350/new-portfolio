...
export default async function Stats() {
    ...
    return (
        <div className="flex flex-col  min-w-[50%] max-w-full rounded-lg overflow-hidden shadow-lg m-4 md:m-12" style={{
            backgroundImage: `linear-gradient(180deg, rgba(0, 0, 0, 1.0) 0%, rgba(0, 0, 0, 0.85) 70%, rgba(0, 0, 0, 0.6) 100%), url('${lastFmData.image}')`,
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            backgroundRepeat: 'no-repeat',
        }}>
            {/* VS Code stats from waka time, weekly */}
            <div className="flex flex-col items-start justify-center gap-4 md:gap-6 p-4 md:p-6">
                <h1 className="text-3xl md:text-4xl 2xl:text-5xl font-bold text-white" style={saira.style}>
                    <Icon icon="catppuccin:vscode" className="mr-2" />
                </h1>
            ...
            <div className="p-4 md:p-6">
                <p className="text-sm md:text-md 2xl:text-lg text-gray-500" style={didactGothic.style}>
                    {lastFmData.currentlyPlaying ? "Currently Playing" : "Last Track"}
                </p>
