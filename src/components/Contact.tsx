    ...
    return (
        <div className="flex flex-col items-center justify-center gap-4 2xl:gap-6 w-full mt-16 d:mt-8 z-10 md:p-8">
            <div className="flex flex-col items-center justify-center gap-2">
                <h2 className="text-3xl md:text-4xl 2xl:text-5xl font-bold text-white" style={saira.style}>Got a project in mind?</h2>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-4 w-fit">
                <a
                    ...
                    className="min-w-full md:min-w-auto px-4 py-2 bg-taupe-900 hover:bg-taupe-800 text-taupe-300/90 rounded-md text-md 2xl:text-lg font-semibold transition-colors duration-300 border-taupe-600 border flex justify-center items-center"
